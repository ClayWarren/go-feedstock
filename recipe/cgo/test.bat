...
rem Fork-only diagnostic; this is not full package acceptance.
go test -count=1 -timeout=5m -v -run="TestBadSymbol|TestResponseFile" cmd/cgo/internal/testerrors cmd/link
if errorlevel 1 exit /b 1
exit /b 0
